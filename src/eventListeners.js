...
// Setup login form
export var loginForm = new LoginForm();
// Setup signup form
export var signupForm = new SignupForm();
...
export function setFormSubmitListeners(options) {
    ...
    signupEl.addEventListener('submit', function (e) {
        ...
        var formData = {
            ...
            //@ts-ignore
            recaptcha: ((_b = (_a = document.body) === null || _a === void 0 ? void 0 : _a.data) === null || _b === void 0 ? void 0 : _b.recaptcha) || null
        };
